...
public class DescriptionPanel extends JPanel {
    ...
    public int getAlignmentChoice() { return alignmentChoice; }

    public int getBackgroundChoice() { return backgroundChoice; }
    ...
    private JPanel createNamePanel() {
        JPanel panel = new JPanel();
            ...
            for (int i = 0; i < characteristicsHolder.length; i++) panel.add(createField(i));
        return panel;
    }
    ...
    private JPanel createSubPanel(String labelName) {
        JPanel panel = new JPanel(new BorderLayout(0, 0));
            ...
            if(labelName.equals("Alignment")) {
                ...
                for (int i = 0; i < alignmentButtons.length; i++) innerPanel.add(alignmentButtons[i]);
                ...
                for (int i = 0; i < backgroundButtons.length; i++) innerPanel.add(backgroundButtons[i]);
            }
        panel.add(label);
    ...
    private DefaultButton createButton(String name, boolean isAlignmentElseBackground, int index) {
        ...
        if (isAlignmentElseBackground) button.addActionListener(e -> updateAlignmentButtons(index));
        else button.addActionListener(e -> updateBackgroundButtons(index));
