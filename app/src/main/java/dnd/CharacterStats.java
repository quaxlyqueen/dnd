...
public class CharacterStats implements Serializable {
    ...
    public boolean validateAbilityScore(int abilityScore) { return false; }

    public Stats[] getStats() { return stats; }

    public Stats getStats(int index) { return stats[index]; }

    public void increaseStat(int targetStat) { stats[targetStat].increaseScore(); }
